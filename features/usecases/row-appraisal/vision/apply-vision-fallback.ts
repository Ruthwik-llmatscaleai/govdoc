...
import type { EvaluationResult, Status } from "@/features/usecases/row-appraisal/types";
import { VISION_FALLBACK_CATEGORIES } from "@/features/usecases/row-appraisal/data/valid-categories";
