...
describe("LANDING_AI_PDF_MAPPING", () => {
  it("every value is a real file in the assets directory", () => {
    const assetsDir = resolve(process.cwd(), "features/usecases/row-appraisal/assets");
  ...
  it("DEFAULT_MARKDOWN_ASSET is a real file in the assets directory", () => {
    const fullPath = resolve(process.cwd(), "features/usecases/row-appraisal/assets", DEFAULT_MARKDOWN_ASSET);
