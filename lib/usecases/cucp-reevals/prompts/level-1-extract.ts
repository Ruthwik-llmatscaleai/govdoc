...
export function buildLevel1SystemPrompt(firmRevenues?: FirmRevenues): string {
  ...
  const precedents = buildPrecedentsBlock(1);
...
${startingNumber + 3}. Provide a direct source quote for each fact.${precedents}${revenueContext}
