      ...
      <div className="govdoc-page-inner">
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
          ...
          <div className="flex flex-col justify-center lg:w-[38%]">
            <div className="mb-8 inline-flex w-fit items-center gap-[13px] rounded-full border border-[#78917d] bg-[rgba(247,242,229,0.72)] px-[26px] py-[11px] font-mono text-[11px] font-extrabold uppercase tracking-[0.35em] text-[#20382a]">
            ...
            <p className="mb-8 max-w-[680px] text-[18px] leading-[1.43] tracking-[-0.15px] text-[#242720]">
...
function PipelineIllustration() {
  return (
    <div className="relative flex w-full flex-col gap-4">
      {/* Top labels row */}
      <div className="flex font-mono text-[10px] font-bold uppercase tracking-[0.35em] text-[#9b998a]">
      ...
      <div className="flex w-full items-start justify-center gap-3 lg:gap-5">
        ...
        {/* Arrow 1 */}
        <div className="flex-shrink-0 pt-[130px]">
          <FlowArrow />
        </div>

        {/* Column 2: CHECKS */}
        <div className="flex w-[190px] shrink-0 flex-col items-stretch">
          <EngineCard />
        </div>
        ...
        {/* Column 3: DECIDES */}
        <div className="flex w-[185px] shrink-0 flex-col items-center">
          <VerdictCard />
        </div>
      </div>
    ...
    <div className="flex flex-col items-center">
      <div className="relative h-[260px] w-full max-w-[180px]">
        <svg viewBox="0 0 200 290" className="relative h-full w-auto mx-auto drop-shadow-[0_18px_28px_rgba(26,29,24,0.16)]" aria-hidden="true">
          {/* Main page */}
          <path
            d="M0 6 C0 3 3 0 6 0 L155 0 L200 45 L200 284 C200 287 197 290 194 290 L6 290 C3 290 0 287 0 284 Z"
            fill="#f7f2e5"
            stroke="#d8d0bc"
            strokeWidth="1"
          />
    ...
    <div className="flex w-full flex-col items-stretch gap-3">
      <div className="relative h-[260px] w-full">
        <div className="relative h-full overflow-hidden rounded-[8px] border border-[#2c4e3b] p-5 shadow-[0_18px_28px_rgba(26,29,24,0.18)]" style={{ background: "#0f1813" }}>
          ...
          <div
            className="mb-4 text-[28px] text-[#f7f2e5]"
            style={{
              fontFamily: "var(--font-display)",
              fontWeight: 400,
              fontStyle: "italic",
          ...
          <div className="mb-4 space-y-[14px]">
            <div className="flex items-center gap-[13px] font-mono text-[10px] font-semibold tracking-[0.18em] text-[#d8d0bc]">
              <span className="inline-block h-[10px] w-[10px] rounded-full bg-[#5f9b72]" />
              Extract Facts
            </div>
            <div className="flex items-center gap-[13px] font-mono text-[10px] font-semibold tracking-[0.18em] text-[#d8d0bc]">
              <span className="inline-block h-[10px] w-[10px] rounded-full bg-[#c5a65b]" />
              Apply Rubric
            </div>
            <div className="flex items-center gap-[13px] font-mono text-[10px] font-semibold tracking-[0.18em] text-[#d8d0bc]">
              <span className="inline-block h-[10px] w-[10px] rounded-full bg-[#a14435]" />
              Issue Verdict
            </div>
          </div>
          ...
          <div className="rounded-md border border-[#c5a65b] px-4 py-2 text-center">
            <div className="font-mono text-[8px] font-extrabold uppercase tracking-[0.3em] text-[#c5a65b]">
              Verdict
            </div>
            <div
              className="text-[22px] text-[#efeadd]"
            style={{
              fontFamily: "var(--font-display)",
              fontWeight: 400,
              fontStyle: "italic",
      ...
      <div className="relative w-full">
        <div className="rounded-[9px] px-[18px] py-[14px] shadow-[0_8px_18px_rgba(26,29,24,0.18)]" style={{ background: "#0a0d0b" }}>
          <div className="mb-1 font-mono text-[8px] font-extrabold uppercase tracking-[0.25em] text-[#c5a65b]">
            Natural Language
          </div>
          <div
            className="text-[13px] leading-[1.18] text-[#efeadd]"
            style={{
              fontFamily: "var(--font-display)",
              fontStyle: "italic",
    ...
    <div className="flex flex-col items-center">
      <div className="relative h-[300px] w-full max-w-[185px]">
        <div className="relative h-full rounded-[8px] border-[3px] border-solid border-[#2b4d3a] bg-[#f7f2e5] p-5 shadow-[0_0_0_5px_rgba(43,77,58,0.10),0_18px_28px_rgba(26,29,24,0.16)]">
          ...
          {/* Header */}
          <div className="mb-2 font-mono text-[9px] font-extrabold uppercase tracking-[0.3em] text-[#2b4d3a]">
            Verdict · Cited
          </div>

          {/* Main verdict text */}
          <div
            className="mb-3 leading-[1.02] text-[#2b211d]"
            style={{
              fontFamily: "var(--font-display)",
              fontSize: "26px",
              fontWeight: 400,
          ...
          <div className="mb-3 space-y-2">
            <div className="rounded-md border border-[#78917d] bg-[#eef3e9] px-[13px] py-1.5 font-mono text-[9px] font-bold tracking-[0.06em] text-[#2b4d3a]">
              Gov Code §11130
            </div>
            <div className="rounded-md border border-[#78917d] bg-[#eef3e9] px-[13px] py-1.5 font-mono text-[9px] font-bold tracking-[0.06em] text-[#2b4d3a]">
              CCR Title 2 §15.04(b)
          ...
          {/* Recommendation */}
          <div className="mb-1.5 font-mono text-[8px] uppercase tracking-[0.25em] text-[#9b998a]">
            Recommendation
          </div>
          <div className="rounded-md bg-[#2b4d3a] px-3 py-2 text-center font-mono text-[11px] font-extrabold uppercase tracking-[0.25em] text-[#f7f2e5]">
            Tier-2 Review
          </div>

          {/* Footer */}
          <div
            className="mt-2 text-[12px] text-[#8c8b7d]"
            style={{
              fontFamily: "var(--font-display)",
              fontStyle: "italic",
              fontVariationSettings: '"opsz" 48',
