...
const TEXTAREA_CLASS =
  "mt-1 block w-full rounded-lg border border-[var(--color-line)] bg-[var(--color-field-bg)] p-2 text-sm transition-colors focus:border-[var(--color-govdoc-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-soft)] resize-none";

const INPUT_CLASS =
  "block w-full rounded-lg border border-[var(--color-line)] bg-[var(--color-field-bg)] p-2 text-sm transition-colors focus:border-[var(--color-govdoc-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-soft)]";
