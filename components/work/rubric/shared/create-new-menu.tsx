  ...
  return (
    <div ref={ref} className="relative inline-block">
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        className="inline-flex items-center gap-1.5 rounded-lg bg-[var(--color-govdoc-deep)] px-3 py-1.5 text-xs font-semibold text-primary-foreground transition hover:bg-[var(--color-govdoc-primary)]"
      >
        {label}
        <svg
          aria-hidden="true"
